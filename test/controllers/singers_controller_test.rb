...
class SingersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create singer" do
    assert_difference('Singer.count') do
      post singers_url, params: { singer: { age: @singer.age, name: @singer.name, surname: @singer.surname } }, as: :json
    end
  ...
  test "should update singer" do
    patch singer_url(@singer), params: { singer: { age: @singer.age, name: @singer.name, surname: @singer.surname } }, as: :json
    assert_response 200
  end
